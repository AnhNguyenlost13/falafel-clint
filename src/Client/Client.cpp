...
#if defined(__TEST__)
	WinrtUtils::setWindowTitle(fmt::format("🧆 falafel clint v{} {} {} [{}]", FLARIAL_VERSION, FLARIAL_BUILD_TYPE, FLARIAL_BUILD_DATE, COMMIT_HASH));
#else
	WinrtUtils::setWindowTitle(fmt::format("🧆 falafel clint v{} {} [{}]", FLARIAL_VERSION, FLARIAL_BUILD_DATE, COMMIT_HASH));
#endif
